...
<template>
  <a-entity :position="position" :rotation="rotation" >
    <a-entity :key="id" :position="`0 ${height===undefined?-3:height} 0`" geometry="primitive: p-pσ;" :material="`color: #114ccf;roughness: 0.25; metalness: 0.2;opacity:${opacity||1}`"></a-entity>
  </a-entity>
</template>
